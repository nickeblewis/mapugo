...
var services = angular.module('mapugo.services', ['ngResource']);

//angular.module('fgApp.services', ['ngResource']).
    services.factory('Category', ['$resource', '$http',
    ...
    services.factory('Place', ['$resource', '$http',
        function($resource, $http) {
            return $resource('/api/places/:_id', {}, {
                'count': {method:'PUT', params:{_id: 'count'}},                           
                'distinct': {method:'PUT', params:{_id: 'distinct'}},      
                'find': {method:'PUT', params:{_id: 'find'}, isArray:true},              
                'group': {method:'PUT', params:{_id: 'group'}, isArray:true},            
